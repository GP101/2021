...
void ScreenSize(int x, int y, int fontSizeX, int fontSizeY)
{
    CONSOLE_FONT_INFOEX cfi;
    cfi.cbSize = sizeof(cfi);
    cfi.nFont = 0;
    cfi.dwFontSize.X = fontSizeX; // Width of each character in the font
    cfi.dwFontSize.Y = fontSizeY; // Height
